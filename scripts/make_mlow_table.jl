...
open(out_tex, "w") do io
    ...
    println(io, raw"\tablecaption{\textbf{Variation of $m_{1\%}$ as a function of $m_{\mathrm{low}}$. For each mass-model, we report the posterior mode and the 90\% highest density credible interval.}\label{tab:mlow-vs-m1}}")
