...
\begin{equation}
    ...
    m_1 m_2 \frac{\dd N}{\dd m_1 \dd m_2 \dd V \dd t} = R f\left( m_1 \right) f\left( m_2 \right) g(m_1, m_2) r(z)
\end{equation}
...
\end{equation}
The redshift evolution is forced to follow a Madau-Dickinson star formation rate
\citep{Madau2014}
\begin{equation}
    r(z) = \frac{\left( 1 + z \right)^{2.7}}{1 + \left( \frac{1+z}{1+1.9} \right)^{5.6}} \left( 1 + \left( \frac{1}{1+1.9} \right)^{5.6} \right).
\end{equation}
