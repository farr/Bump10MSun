...
\, M_\odot$\ldots.} Our models respond to the overall abundance of mergers
...
\citet{Mandel:2018mve,pop-vitale,popgw2,popgw3}.\chreplaced[id=W]{.}{}
...
the low-mass BBH population \chcomment[id=W]{?}. \chreplaced[id=W]{}{} Our canonical analysis uses $(3M_{\odot},
...
masses). \chcomment[id=W]{.} During inference, we further impose
...
systems whose only compact object components are BHs, \chcomment[id=W]{.} in contrast to other GW-based studies~\citep{Farah:2021qom}
