...
\begin{abstract}
    In recent years, the existence of a gap in the mass spectrum of compact objects
    formed from stellar collapse, between the heaviest neutron stars and the lightest
    black holes, has been a matter of significant debate. The presence or absence of a mass
    ...
    flexible parameterized models for the mass function, we find, similar to existing studies, a sharp peak in
    the mass function at $m \simeq (8-10 M_{\odot})$. In particular, we observe a steady
    decline in the merger rate by less than an order of magnitude and find that the $1\%$ black hole mass in our most flexible model
    is $m_{1\%} = \monepctplgplpincludingnewunits$. In other words, this sample
    of low-mass black holes does not require a mass gap.
