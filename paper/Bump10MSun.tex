...
\begin{figure}
    ...
    this analysis.  The contours show the $0.1$ and $0.5$ credible regions for
    each event.  The dashed lines show our selection cuts, with $m_2 > 3 \,
    M_\odot$ and $\mclowunits < M_c < \mchighunits$.}
\end{figure}
