...
"""
    make_dNdm1(a1, a2, [a3,] mb[12], [mb23,] mu_q, sigma_q)

Returns a function that computes the marginal density (unnormalized) in `m1`.
With two slopes and one break, use the single-break power law; with three slopes
and two breaks, use the two-break power law.
"""
function make_dNdm1(a1, a2, mb, mu_q, sigma_q)
    log_dN = make_log_dN(a1, a2, mb, mu_q, sigma_q)
    make_dNdm1(log_dN)
end
function make_dNdm1(a1, a2, a3, mb12, mb23, mu_q, sigma_q)
...
"""
    make_dNdm2(a1, a2, [a3,] mb[12], [mb23,], mu_q, sigma_q)

Returns a function that computes the marginal density (unnormalized) in `m2`;
with two slopes and one break, uses the single-break power law; with three
slopes and two breaks, uses the two-break power law.
"""
function make_dNdm2(a1, a2, mb, mu_q, sigma_q)
    log_dN = make_log_dN(a1, a2, mb, mu_q, sigma_q)
    make_dNdm2(log_dN)
end
function make_dNdm2(a1, a2, a3, mb12, mb23, mu_q, sigma_q)
    log_dN = make_log_dN(a1, a2, a3, mb12, mb23, mu_q, sigma_q)
    make_dNdm2(log_dN)
end
...
function make_dNdq(a1, a2, a3, mb12, mb23, mu_q, sigma_q)
    log_dN = make_log_dN(a1, a2, a3, mb12, mb23, mu_q, sigma_q)
    make_dNdq(log_dN)
end
